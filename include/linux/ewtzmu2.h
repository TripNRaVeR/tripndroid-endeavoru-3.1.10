...
#define EWDAE_IOCTL_GET_AKM_DATA		_IOR(EWDAEIO, 0x12, short[12]) /* for akm data */
...
#define EWDAE_IOCTL_GET_GYRO_CAL_DATA		_IOR(EWDAEIO, 0x18, unsigned char[12]) /* for gyro cal data for emmc */
