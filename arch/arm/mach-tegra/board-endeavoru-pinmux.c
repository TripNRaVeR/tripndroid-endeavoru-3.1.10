...
static __initdata struct tegra_pingroup_config enterprise_pinmux_modem[] = {
	DEFAULT_PINMUX(LCD_PWR1,        DISPLAYA,        NORMAL,    NORMAL,     OUTPUT), // MDM_AP2BB_RST_PWRDWN // TripNRaVeR: patched
	...
	DEFAULT_PINMUX(KB_ROW13,        KBC,             NORMAL,    NORMAL,     INPUT),  // MDM_BB2AP_RST2 // TripNRaVeR: patched
...
static __initdata struct tegra_pingroup_config endeavoru_pinmux_common[] = {
	...
	DEFAULT_PINMUX(GPIO_PU0,        UARTA,           NORMAL,       NORMAL,     INPUT), // CON_BT_EN // TripNRaVeR: patched
	DEFAULT_PINMUX(GPIO_PU1,        UARTA,           NORMAL,       NORMAL,     INPUT), // TripNRaVeR: patched
	DEFAULT_PINMUX(GPIO_PU2,        UARTA,           NORMAL,       NORMAL,     INPUT), // TripNRaVeR: patched
	...
	*/
	...
	DEFAULT_PINMUX(ULPI_DATA4,      ULPI,            NORMAL,       NORMAL,     INPUT), // BT UART CTS (wake up) // TripNRaVeR: patched
	...
	/* JTAG Support */
	DEFAULT_PINMUX(JTAG_RTCK,       RTCK,            NORMAL,       NORMAL,     OUTPUT), // TripNRaVeR: patched

	/* PCI-Express */
	// TripNRaVeR: start 10x PCIEX patched
	...
	// TripNRaVeR: end 10x PCIEX patched
};
